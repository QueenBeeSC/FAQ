...
A [global network](https://medium.com/arcade-city-press/getting-organized-62b91a7a0541) building a decentralized app, built on the Ethereum blockchain, to create a community of open marketplaces for the exchange of services between peers
</details>
...
Who is behind the Swarm City product development?
[Business & Tech Team](https://getactivein.swarm.city/) [Advisors](https://advisors.swarm.city/)

Is there a Swarm City app available now?
...
Is the Swarm City app ready to use for ridesharing?
...
How are people using Swarm City for ridesharing before it's available in the app?
...
Will the Swarm City app be downloadable in the playstore?
...
Where can I can find more info about the project history?
...
How is Swarm City associated with Arcade City?
...
Where can I access the official logo files?
Github [swarm.city branding](https://github.com/swarmcity/branding.git)

What types of other services will be offered on the platform?
...
What forms of payment are accepted within the app?
...
Can I buy SWT with a credit card?
Yes, on [Changelly](https://chengelly.com)

Where do I store my tokens?
...
I bought ARC tokens, what can I do with them?
...
Where do I go to exchange my previously purchased ARC for SWT?
You will start the exchange by going to the Swarm City Terminal, [enter here]( https://swarm.city)

Is there any way I can I exchange ARC tokens for SWT without using the Terminal swap feature?
...
Where can I view and store my SWT after the exchange?
...
How can I trade SWT with other users?
...
Where can I see the total amount of SWT currently minted?
...
Where can I view the original project whitepaper?
...
Is there a more technical updated whitepaper?
...
How do I view the ERC-20 token contract?
...
How can I view SWT transactions?
